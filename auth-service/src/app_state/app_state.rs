...
use crate::domain::{data_stores::{BannedTokenStore, TwoFACodeStore, UserStore}, email_client::EmailClient};
...
impl AppState {
    pub fn new(
        ...
        Self { user_store, token_store, two_fa_code_store, email_client }
    }
}